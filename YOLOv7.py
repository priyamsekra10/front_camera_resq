...
class YOLOv7:
    ...
    def initialize_model(self, path):
        ...
        # print("yolo output: " ,self.get_output_details())
    ...
    def detect_objects(self, image):
        ...
        # input_frame1 = cv2.resize(image, (40, 24))
        # input_frame2 = cv2.resize(image, (80, 48))
        # input_frame3 = cv2.resize(image, (20,12))

        # input_tensor1 = self.prepare_input(input_frame1)
        # input_tensor2 = self.prepare_input(input_frame2)
        # input_tensor3 = self.prepare_input(input_frame3)
        ...
        # outputs = self.inference(input_tensor1,input_tensor2,input_tensor3)
    ...
    def get_input_details(self):
        ...
        print("yolo input names: " ,a)
        # print("yolo input shape: " ,self.input_shape())
        # print("yolo input height: " ,self.self.input_height())
        # print("yolo input widht: " ,self.self.input_width())
