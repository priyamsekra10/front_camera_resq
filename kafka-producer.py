...
producer = KafkaProducer(bootstrap_servers='13.201.34.30:9092',     max_request_size=26214400 )
# producer = KafkaProducer(bootstrap_servers='localhost:9092',     max_request_size=26214400 )
topic = 'video'
